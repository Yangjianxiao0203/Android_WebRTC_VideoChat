...
public class CompleteActivity extends AppCompatActivity {
    ...
    private void connectToSignallingServer() {
        try {
            ...
            // $ hostname -I
            String URL = "https://mysterious-thicket-63645-7507d48e7fad.herokuapp.com/";// "https://calm-badlands-59575.herokuapp.com/"; //
                ...
                peerConnection.getStats(new StatsObserver() {
                    ...
                    public void onComplete(StatsReport[] reports) {
                        for (StatsReport report : reports) {
                            // 这里，我们只打印了报告的类型和id，你可以根据你的需求对报告进行更详细的处理
                            Log.d(TAG, "Stats report: " + report.type + ", id: " + report.id);
                            Log.d(TAG,"Stats latency: " + report.timestamp);
                            // 如需获取更多信息，可以使用 report.trackStats, report.codecStats, report.bweStats 等属性
                        }
                    }
                }, null);  // 第二个参数可以指定一个特定的 MediaStreamTrack。如果为 null，将返回所有 tracks 的统计信息。
